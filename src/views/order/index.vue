<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" prop="user.nickName" label="发布用户"></el-table-column>
      <el-table-column align="center" prop="receive_order.user.nickName" label="接收用户"></el-table-column>
      <el-table-column align="center" prop="status" label="状态"></el-table-column>
      <el-table-column align="center" prop="is" label="类型"></el-table-column>
...
<script>
import { getOrderList, deleteOrder, updateOrder, addOrder } from "@/api/order";
...
export default {
  ...
  methods: {
    async fetchData() {
      ...
      await getOrderList(this.query).then((res) => {
